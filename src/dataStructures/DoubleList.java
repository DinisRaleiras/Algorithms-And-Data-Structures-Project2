...
{   
	...
	/**
	 * Writes the content of the list. We rewrite this method to avoid the serialization issues
	 * @param s
	...
	private void writeObject(java.io.ObjectOutputStream s) throws java.io.IOException {
		...
		for (DoubleListNode<E> x = head; x != null; x = x.getNext())
			s.writeObject(x.getElement());

	}

	/**
	 * Reads the content of the list. We rewrite this method to avoid the serialization issues
	 * @param s
	 * @throws java.io.IOException
